...
process_the_feed: function process_the_feed(message_type, message_data)
{
    ...
    switch(message_type) {                
        ...
        case "update_submit_manager_offer_to_worker":
                ...
                html_text = `<b>P${player_info.player_label} | G${player_info.group.id}:</b> Offered ${offer.toFixed(2)}p to their counterpart for their goods (${value}p) in Phase 2.`;
                break;
        case "update_submit_worker_response_to_manager":
                ...
                html_text = `<b>P${player_info.player_label} | G${player_info.group.id}:</b> ${response} their counterpart's offer of 
                             ${player_info.group.manager_offer.toFixed(2)}p for their goods (${player_info.group["player_" + player_info.player_number + "_total_value"]}p) in Phase 2.`;
                break;
